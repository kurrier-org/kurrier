...
async function Page() {
    ...
    const createContactAction = async (_prev: FormState, formData: FormData) => {
        ...
        return handleAction(async () => {
            ...
            const [newContact] = await rls((tx) =>
                tx.insert(contacts).values(res.data as ContactCreate).returning()
            );
    ...
    return <NewContactForm createContactAction={createContactAction} user={user} publicConfig={publicConfig} />
}
