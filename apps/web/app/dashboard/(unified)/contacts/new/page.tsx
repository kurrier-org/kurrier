...
import {addressBooks, ContactCreate, ContactInsertSchema, contacts} from "@db";
	...
	const createContactAction = async (_prev: FormState, formData: FormData) => {
		...
		return handleAction(async () => {
            ...
            if (!defaultAddressBook) {
                return { success: false, error: "No default address book found for user." };
            }
            ...
            davQueue.add("dav:create-contact", {contactId: newContact.id, ownerId: newContact.ownerId})
