...
export default function SnoozeMail({
    ...
    const [snoozedUntil, setSnoozedUntil] = useState<Date | null>(initialSnoozedUntil);
    ...
    const presets = useMemo(
        () => [
            ...
            { label: "Tomorrow morning", date: dayjsTz().endOf("d").add(8, "h").add(1, "m") },
            { label: "Tomorrow afternoon", date: dayjsTz().endOf("d").add(13, "h").add(1, "m") },
            { label: "Monday morning", date: dayjsTz().endOf("w").add(8, "h").add(1, "m") },
        ],
        [dayjsTz],
    );
