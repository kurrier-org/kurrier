...
export default function EmailHeaderContacts({ name, toEmail, maxTags, onChange }: { toEmail?: string, maxTags?: number, onChange?: (value: string[]) => void, name: string }) {
