...
import {
    Inbox, Send, FileText, Archive, Ban, Trash2, Folder,
...
function buildTree(rows: MailboxEntity[], unreadCounts: FetchMailboxUnreadCountsResult): TreeMailbox[] {
                        ...
                        {m.kind === "custom" && (
                            <Menu withinPortal position="right-start" offset={4}>
                                ...
                                <Menu.Dropdown onClick={e => e.stopPropagation()}>
                                    <DeleteMailboxFolder mailboxId={m.id} identityPublicId={identityPublicId} imapOp={!!identity.smtpAccountId} />
                                </Menu.Dropdown>
                            </Menu>
                        )}
                    </div>
