...
exports.ProviderAccountFormSchema =
	exports.DomainIdentityFormSchema =
	exports.SmtpAccountFormSchema =
		void 0;
// @ts-nocheck
...
var cleanKV = function (obj) {
	return Object.fromEntries(
		Object.entries(obj !== null && obj !== void 0 ? obj : {}).filter(
			function (_a) {
				var v = _a[1];
				return v !== "" && v != null;
			},
...
exports.ProviderAccountFormSchema = zod_1.z.object({
	...
	required: zod_1.z.record(
		zod_1.z.string(),
		zod_1.z.string().min(1, "Value is required"),
	),
});
