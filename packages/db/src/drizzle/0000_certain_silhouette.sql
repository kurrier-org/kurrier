...
ALTER TABLE "calendar_event_attendees" ADD CONSTRAINT "calendar_event_attendees_contact_id_contacts_id_fk" FOREIGN KEY ("contact_id") REFERENCES "public"."contacts"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "ix_calendar_events_owner_dav_uri" ON "calendar_events" USING btree ("owner_id","dav_uri") WHERE "calendar_events"."dav_uri" IS NOT NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "ux_contacts_owner_dav_uri" ON "contacts" USING btree ("owner_id","dav_uri") WHERE "contacts"."dav_uri" IS NOT NULL;--> statement-breakpoint
...
CREATE POLICY "apikeys_delete_own" ON "api_keys" AS PERMISSIVE FOR DELETE TO "authenticated" USING ("api_keys"."owner_id" = (select auth.uid()));--> statement-breakpoint
...
CREATE POLICY "app_migrations_delete_own" ON "app_migrations" AS PERMISSIVE FOR DELETE TO "authenticated" USING ("app_migrations"."owner_id" = (select auth.uid()));--> statement-breakpoint
...
CREATE POLICY "event_attendees_delete_own" ON "calendar_event_attendees" AS PERMISSIVE FOR DELETE TO "authenticated" USING ("calendar_event_attendees"."owner_id" = (select auth.uid()));--> statement-breakpoint
...
CREATE POLICY "calendars_delete_own" ON "calendars" AS PERMISSIVE FOR DELETE TO "authenticated" USING ("calendars"."owner_id" = (select auth.uid()));--> statement-breakpoint
...
CREATE POLICY "contact_labels_delete_own" ON "contact_labels" AS PERMISSIVE FOR DELETE TO "authenticated" USING ("contact_labels"."owner_id" = (select auth.uid()));--> statement-breakpoint
...
CREATE POLICY "contacts_delete_own" ON "contacts" AS PERMISSIVE FOR DELETE TO "authenticated" USING ("contacts"."owner_id" = (select auth.uid()));--> statement-breakpoint
...
CREATE POLICY "dav_accounts_delete_own" ON "dav_accounts" AS PERMISSIVE FOR DELETE TO "authenticated" USING ("dav_accounts"."owner_id" = (select auth.uid()));--> statement-breakpoint
...
CREATE POLICY "mbtlabel_delete_own" ON "mailbox_thread_labels" AS PERMISSIVE FOR DELETE TO "authenticated" USING ("mailbox_thread_labels"."owner_id" = (select auth.uid()));--> statement-breakpoint
...
CREATE POLICY "threads_delete_own" ON "threads" AS PERMISSIVE FOR DELETE TO "authenticated" USING ("threads"."owner_id" = (select auth.uid()));--> statement-breakpoint
