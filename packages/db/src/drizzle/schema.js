...
exports.mailboxThreadLabels =
	exports.labels =
	exports.webhooks =
	exports.apiKeys =
	exports.mailboxThreads =
	exports.threads =
	exports.messages =
	exports.messageAttachments =
	exports.mailboxSync =
	exports.mailboxes =
	exports.identities =
	exports.smtpAccountSecrets =
	exports.smtpAccounts =
	exports.providerSecrets =
	exports.providers =
	exports.secretsMeta =
	exports.WebHookEnum =
	exports.ApiScopeEnum =
	exports.mailboxSyncPhaseEnum =
	exports.MessagePriorityEnum =
	exports.MessageStateEnum =
	exports.MailboxKindEnum =
	exports.IdentityStatusEnum =
	exports.IdentityKindEnum =
	exports.ProviderKindEnum =
		void 0;
// @ts-nocheck
...
exports.ProviderKindEnum = (0, pg_core_1.pgEnum)(
	"provider_kind",
	_schema_1.providersList,
);
exports.IdentityKindEnum = (0, pg_core_1.pgEnum)(
	"identity_kind",
	_schema_1.identityTypesList,
);
exports.IdentityStatusEnum = (0, pg_core_1.pgEnum)(
	"identity_status",
	_schema_1.identityStatusList,
);
exports.MailboxKindEnum = (0, pg_core_1.pgEnum)(
	"mailbox_kind",
	_schema_1.mailboxKindsList,
);
exports.MessageStateEnum = (0, pg_core_1.pgEnum)(
	"message_state",
	_schema_1.messageStatesList,
);
exports.MessagePriorityEnum = (0, pg_core_1.pgEnum)(
	"message_priority",
	_schema_1.messagePriorityList,
);
exports.mailboxSyncPhaseEnum = (0, pg_core_1.pgEnum)(
	"mailbox_sync_phase",
	_schema_1.mailboxSyncPhase,
);
exports.ApiScopeEnum = (0, pg_core_1.pgEnum)(
	"api_scope",
	_schema_1.apiScopeList,
);
exports.WebHookEnum = (0, pg_core_1.pgEnum)(
	"webhook_list",
	_schema_1.webHookList,
);
exports.secretsMeta = (0, pg_core_1.pgTable)(
	"secrets_meta",
	{
		id: (0, pg_core_1.uuid)("id").defaultRandom().primaryKey(),
		ownerId: (0, pg_core_1.uuid)("owner_id")
			.references(function () {
				return supabase_schema_1.users.id;
			})
			.notNull()
			.default(
				(0, drizzle_orm_1.sql)(
...
exports.providers = (0, pg_core_1.pgTable)(
	"providers",
	{
		id: (0, pg_core_1.uuid)("id").defaultRandom().primaryKey(),
		ownerId: (0, pg_core_1.uuid)("owner_id")
	...
	function (t) {
		return [
			(0, pg_core_1.uniqueIndex)("uniq_provider_per_user").on(
				t.ownerId,
				t.type,
			),
...
exports.providerSecrets = (0, pg_core_1.pgTable)(
	"provider_secrets",
	{
		id: (0, pg_core_1.uuid)("id").defaultRandom().primaryKey(),
...
exports.smtpAccounts = (0, pg_core_1.pgTable)(
	"smtp_accounts",
	{
		id: (0, pg_core_1.uuid)("id").defaultRandom().primaryKey(),
		ownerId: (0, pg_core_1.uuid)("owner_id")
...
exports.smtpAccountSecrets = (0, pg_core_1.pgTable)(
	"smtp_account_secrets",
	{
		...
		accountId: (0, pg_core_1.uuid)("account_id")
			.references(
				function () {
					return exports.smtpAccounts.id;
				},
				{ onDelete: "cascade" },
			)
			.notNull(),
...
exports.identities = (0, pg_core_1.pgTable)(
	"identities",
	{
		id: (0, pg_core_1.uuid)("id").defaultRandom().primaryKey(),
		ownerId: (0, pg_core_1.uuid)("owner_id")
		...
		metaData: (0, pg_core_1.jsonb)("meta").$type().default(null),
		providerId: (0, pg_core_1.uuid)("provider_id").references(function () {
			return exports.providers.id;
		}), // SES/SendGrid/Mailgun/Postmark
		smtpAccountId: (0, pg_core_1.uuid)("smtp_account_id").references(
			function () {
				return exports.smtpAccounts.id;
			},
		), // Custom SMTP
		status: (0, exports.IdentityStatusEnum)("status")
			.notNull()
			.default("unverified"),
		createdAt: (0, pg_core_1.timestamp)("created_at", { withTimezone: true })
			.defaultNow()
	...
	function (t) {
		return [
			(0, pg_core_1.uniqueIndex)("uniq_identity_per_user").on(
				t.ownerId,
				t.kind,
				t.value,
			),
...
exports.mailboxes = (0, pg_core_1.pgTable)(
	"mailboxes",
	{
		id: (0, pg_core_1.uuid)("id").defaultRandom().primaryKey(),
		ownerId: (0, pg_core_1.uuid)("owner_id")
...
exports.mailboxSync = (0, pg_core_1.pgTable)(
	"mailbox_sync",
	{
		id: (0, pg_core_1.uuid)("id").defaultRandom().primaryKey(),
		identityId: (0, pg_core_1.uuid)("identity_id")
		...
		mailboxId: (0, pg_core_1.uuid)("mailbox_id")
			...
			.notNull(),
		uidValidity: (0, pg_core_1.bigint)("uid_validity", {
			mode: "bigint",
		}).notNull(),
		lastSeenUid: (0, pg_core_1.bigint)("last_seen_uid", { mode: "number" })
			.notNull()
			.default(0),
		backfillCursorUid: (0, pg_core_1.bigint)("backfill_cursor_uid", {
			mode: "number",
		})
			.notNull()
			.default(0),
		highestModseq: (0, pg_core_1.numeric)("highest_modseq", {
			precision: 20,
			scale: 0,
		}),
		phase: (0, exports.mailboxSyncPhaseEnum)("phase")
			.notNull()
			.default("BOOTSTRAP"),
		...
		updatedAt: (0, pg_core_1.timestamp)("updated_at", { withTimezone: true })
			...
			.$onUpdateFn(function () {
				return (0, drizzle_orm_1.sql)(
					templateObject_43 ||
						(templateObject_43 = __makeTemplateObject(["now()"], ["now()"])),
				);
			}),
	},
	function (table) {
		return {
			uxMailbox: (0, pg_core_1.uniqueIndex)("ux_mailbox_sync_mailbox").on(
				table.mailboxId,
			),
			ixIdentity: (0, pg_core_1.index)("ix_mailbox_sync_identity").on(
				table.identityId,
			),
...
exports.messageAttachments = (0, pg_core_1.pgTable)(
	"message_attachments",
	{
		id: (0, pg_core_1.uuid)("id").defaultRandom().primaryKey(),
		ownerId: (0, pg_core_1.uuid)("owner_id")
...
exports.messages = (0, pg_core_1.pgTable)(
	"messages",
	{
		...
		priority: (0, exports.MessagePriorityEnum)("priority").default(
			(0, drizzle_orm_1.sql)(
				templateObject_52 ||
					(templateObject_52 = __makeTemplateObject(["null"], ["null"])),
			),
		),
		...
		from: (0, pg_core_1.jsonb)("from")
			.$type()
			.default(
				(0, drizzle_orm_1.sql)(
					templateObject_53 ||
						(templateObject_53 = __makeTemplateObject(["null"], ["null"])),
				),
			),
		to: (0, pg_core_1.jsonb)("to")
			.$type()
			.default(
				(0, drizzle_orm_1.sql)(
					templateObject_54 ||
						(templateObject_54 = __makeTemplateObject(["null"], ["null"])),
				),
			),
		cc: (0, pg_core_1.jsonb)("cc")
			.$type()
			.default(
				(0, drizzle_orm_1.sql)(
					templateObject_55 ||
						(templateObject_55 = __makeTemplateObject(["null"], ["null"])),
				),
			),
		bcc: (0, pg_core_1.jsonb)("bcc")
			.$type()
			.default(
				(0, drizzle_orm_1.sql)(
					templateObject_56 ||
						(templateObject_56 = __makeTemplateObject(["null"], ["null"])),
				),
			),
		...
		hasAttachments: (0, pg_core_1.boolean)("has_attachments")
			.notNull()
			.default(false),
		state: (0, exports.MessageStateEnum)("state").notNull().default("normal"),
		headersJson: (0, pg_core_1.jsonb)("headers_json").$type().default(null),
	...
	function (t) {
		return [
			...
			(0, pg_core_1.uniqueIndex)("uniq_mailbox_message_id").on(
				t.mailboxId,
				t.messageId,
			),
			(0, pg_core_1.index)("idx_messages_in_reply_to").on(t.inReplyTo),
			(0, pg_core_1.index)("ix_messages_thread_flagged").on(
				t.threadId,
				t.flagged,
			),
			(0, pg_core_1.index)("idx_messages_mailbox_date").on(t.mailboxId, t.date),
			(0, pg_core_1.index)("idx_messages_mailbox_seen_date").on(
				t.mailboxId,
				t.seen,
				t.date,
			),
...
exports.threads = (0, pg_core_1.pgTable)(
	"threads",
	{
		id: (0, pg_core_1.uuid)("id").defaultRandom().primaryKey(),
		ownerId: (0, pg_core_1.uuid)("owner_id")
		...
		lastMessageDate: (0, pg_core_1.timestamp)("last_message_date", {
			withTimezone: true,
		}), // nullable until first msg written
	...
	function (t) {
		return [
			(0, pg_core_1.index)("idx_threads_owner_lastdate").on(
				t.ownerId,
				t.lastMessageDate,
				t.id,
			),
...
exports.mailboxThreads = (0, pg_core_1.pgTable)(
	"mailbox_threads",
	{
		threadId: (0, pg_core_1.uuid)("thread_id")
			.references(
		...
		firstMessageAt: (0, pg_core_1.timestamp)("first_message_at", {
			withTimezone: true,
		}),
		messageCount: (0, pg_core_1.integer)("message_count").notNull().default(0),
	...
	function (t) {
		return [
			...
			(0, pg_core_1.index)("ix_mbth_mailbox_activity").on(
				t.mailboxId,
				t.lastActivityAt,
				t.threadId,
			),
			(0, pg_core_1.index)("ix_mbth_identity_slug").on(
				t.identityId,
				t.mailboxSlug,
			),
			(0, pg_core_1.index)("ix_mbth_identity_public_id").on(t.identityPublicId),
			(0, pg_core_1.index)("ix_mbth_mailbox_unread").on(
				t.mailboxId,
				t.unreadCount,
			),
			(0, pg_core_1.index)("ix_mbth_mailbox_starred").on(
				t.mailboxId,
				t.starred,
			),
			(0, pg_core_1.uniqueIndex)("ux_mbth_thread_mailbox").on(
				t.threadId,
				t.mailboxId,
			),
	...
	"api_keys",
	{
		...
		updatedAt: (0, pg_core_1.timestamp)("updated_at", { withTimezone: true })
			...
			.$onUpdateFn(function () {
				return (0, drizzle_orm_1.sql)(
					templateObject_75 ||
						(templateObject_75 = __makeTemplateObject(["now()"], ["now()"])),
				);
			}),
	},
	function (t) {
		return [
			(0, pg_core_1.uniqueIndex)("ux_api_keys_owner_name").on(
				t.ownerId,
				t.name,
			),
			(0, pg_core_1.uniqueIndex)("ux_api_keys_owner_prefix").on(
				t.ownerId,
				t.keyPrefix,
			),
...
exports.webhooks = (0, pg_core_1.pgTable)(
	"webhooks",
	{
		id: (0, pg_core_1.uuid)("id").defaultRandom().primaryKey(),
		ownerId: (0, pg_core_1.uuid)("owner_id")
...
exports.labels = (0, pg_core_1.pgTable)(
	"labels",
	{
		id: (0, pg_core_1.uuid)("id").defaultRandom().primaryKey(),
		ownerId: (0, pg_core_1.uuid)("owner_id")
...
exports.mailboxThreadLabels = (0, pg_core_1.pgTable)(
	...
	function (t) {
		return [
			...
			(0, pg_core_1.index)("ix_mbtlabel_mailbox_label").on(
				t.mailboxId,
				t.labelId,
			),
