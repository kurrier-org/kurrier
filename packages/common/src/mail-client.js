...
exports.PAGE_SIZE = exports.DEFAULT_COLORS_SWATCH = exports.decodeMailboxPath = exports.encodeMailboxPath = exports.getMessageAddress = exports.getMessageName = exports.fromAddress = exports.fromName = void 0;
...
var fromName = function (message) {
    ...
    return (_d = (_c = (_b = from.value) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.name) !== null && _d !== void 0 ? _d : null;
};
...
var fromAddress = function (message) {
    ...
    return (_c = (_b = (_a = from.value) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.address) !== null && _c !== void 0 ? _c : null;
};
...
var getMessageName = function (message, field) {
    ...
    return (_c = (_b = (_a = value.value) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.name) !== null && _c !== void 0 ? _c : null;
};
...
var getMessageAddress = function (message, field) {
    ...
    return (_c = (_b = (_a = value.value) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.address) !== null && _c !== void 0 ? _c : null;
};
