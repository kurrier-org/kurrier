...
exports.RawPostmarkConfigSchema = exports.RawMailgunConfigSchema = exports.RawSendgridConfigSchema = exports.RawSesConfigSchema = exports.RawSmtpConfigSchema = void 0;
...
exports.RawSmtpConfigSchema = zod_1.z
    ...
    return ({
        ...
        pool: r.SMTP_POOL,
        imap: r.IMAP_HOST && r.IMAP_PORT && r.IMAP_USERNAME && r.IMAP_PASSWORD
            ? {
                host: r.IMAP_HOST,
                port: r.IMAP_PORT,
                user: r.IMAP_USERNAME,
                pass: r.IMAP_PASSWORD,
                secure: (_b = r.IMAP_SECURE) !== null && _b !== void 0 ? _b : true,
            }
            : undefined,
    });
});
