...
var SendgridMailer = /** @class */ (function () {
							...
							2 /*return*/,
							{
								...
								message:
									(_a =
										...
										? _a
										: "SendGrid verify failed",
								meta: {
									code:
										err_1 === null || err_1 === void 0 ? void 0 : err_1.code,
									response:
										(_b =
											err_1 === null || err_1 === void 0
												? void 0
												: err_1.response) === null || _b === void 0
											? void 0
											: _b.body,
								},
							},
	...
	SendgridMailer.prototype.upsertInboundParse = function (
		hostname,
		webhookUrl,
		opts,
	) {
			...
			return __generator(this, function (_c) {
				switch (_c.label) {
					case 0:
						spamCheck =
							(_a =
								opts === null || opts === void 0 ? void 0 : opts.spamCheck) !==
								null && _a !== void 0
								? _a
								: true;
						return [
					...
					case 1:
						listRes = _c.sent()[0];
						all =
							(_b = listRes.body.result) !== null && _b !== void 0 ? _b : [];
						existing = all.find(function (s) {
							var _a;
							return (
								((_a = s.hostname) === null || _a === void 0
									? void 0
									: _a.toLowerCase()) === hostname.toLowerCase()
							);
						});
						...
						return [
							...
							this.client.request({
								method: "DELETE",
								url: "/v3/user/webhooks/parse/settings/".concat(
									existing.hostname,
								),
							}),
						];
											...
											(_b =
												(_a =
													err_3 === null || err_3 === void 0
														? void 0
														: err_3.response) === null || _a === void 0
													? void 0
													: _a.body) !== null && _b !== void 0
												? _b
												: err_3 === null || err_3 === void 0
													? void 0
													: err_3.message) !== null && _c !== void 0
											? _c
											: String(err_3),
								},
							},
			...
			return __generator(this, function (_g) {
				switch (_g.label) {
					...
					case 4:
						...
						if (
							(_b = details.dns) === null || _b === void 0 ? void 0 : _b.dkim1
						) {
							dns.push({
								type: "CNAME",
						...
						if (
							(_c = details.dns) === null || _c === void 0 ? void 0 : _c.dkim2
						) {
							dns.push({
								type: "CNAME",
						...
						status_2 = validation.valid ? "verified" : "unverified";
										...
										(_f =
											(_e =
												(_d =
													e_3 === null || e_3 === void 0
														? void 0
														: e_3.response) === null || _d === void 0
													? void 0
													: _d.body) !== null && _e !== void 0
												? _e
												: e_3 === null || e_3 === void 0
													? void 0
													: e_3.message) !== null && _f !== void 0
											? _f
											: String(e_3),
								},
							},
					...
					case 4:
						...
						messageId =
							...
							((_d =
								response === null || response === void 0
									? void 0
									: response.headers) === null || _d === void 0
								? void 0
								: _d["X-Message-Id"]);
						return [
							2 /*return*/,
