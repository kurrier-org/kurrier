...
var PostmarkMailer = /** @class */ (function () {
	function PostmarkMailer(cfg) {
		this.cfg = cfg;
		this.serverClient = new postmark_1.default.ServerClient(
			cfg.postmarkServerToken,
		);
		this.accountClient = new postmark_1.default.AccountClient(
			cfg.postmarkAccountToken,
		);
	}
		...
		return __awaiter(this, arguments, void 0, function (domain, opts) {
			...
			return __generator(this, function (_b) {
				switch (_b.label) {
					...
					case 1:
						list = _b.sent();
						match = list.Domains.find(function (dom) {
							return dom.Name.toLowerCase() === domain.toLowerCase();
						});
						created = false;
						if (!!match) return [3 /*break*/, 3];
						return [
							4 /*yield*/,
							this.accountClient.createDomain(
								__assign(
									{ Name: domain },
									opts.returnPathDomain
										? {
												ReturnPathDomain: this.normalizeDomain(
													opts.returnPathDomain,
												),
											}
										: {},
					...
					case 4:
						...
						if (details.SPFHost && details.SPFTextValue) {
							dns.push({
								...
								note: "SPF (".concat(
									details.SPFVerified ? "valid" : "pending",
									")",
								),
							});
						}
						...
						if (details.DKIMHost && details.DKIMTextValue) {
							dns.push({
								...
								note: "DKIM (".concat(
									details.DKIMVerified ? "valid" : "pending",
									")",
								),
							});
						}
						...
						if (details.DKIMRevokedHost && details.DKIMRevokedTextValue) {
							dns.push({
								...
								note: "DKIM (revoked".concat(
									details.SafeToRemoveRevokedKeyFromDNS
										? ", safe to remove"
										: "",
									")",
								),
						...
						if (
							...
							details.ReturnPathDomainCNAMEValue
						) {
							dns.push({
								type: "CNAME",
								name: details.ReturnPathDomain,
								value: details.ReturnPathDomainCNAMEValue,
								note: "Return-Path (".concat(
									details.ReturnPathDomainVerified ? "valid" : "pending",
									")",
								),
							});
						}
						status_1 =
							details.SPFVerified && details.DKIMVerified
								? "verified"
								: "unverified";
						return [
							2 /*return*/,
				...
				switch (_c.label) {
					...
					case 7:
						...
						dom = all.find(function (x) {
							return _this.normalizeDomain(x.domain) === d;
						});
		...
		return __awaiter(this, arguments, void 0, function (domain, opts) {
			...
			return __generator(this, function (_c) {
				switch (_c.label) {
					case 0:
						hook =
							(_a = opts.webHookUrl) === null || _a === void 0
								? void 0
								: _a.trim();
						_c.label = 1;
					case 1:
					...
					case 2:
						list = _c.sent();
						match = list.Domains.find(function (x) {
							return x.Name.toLowerCase() === domain.toLowerCase();
						});
						if (!match) {
							return [
								2 /*return*/,
					...
					case 3:
						...
						if (details.DKIMHost && details.DKIMTextValue) {
							...
							details.DKIMPendingHost &&
							details.DKIMPendingTextValue
						) {
							dns.push({
								type: "TXT",
								name: details.DKIMPendingHost,
						...
						return [
							2 /*return*/,
							{
								...
								meta: {
									error:
										(_b =
											err_4 === null || err_4 === void 0
												? void 0
												: err_4.message) !== null && _b !== void 0
											? _b
											: String(err_4),
								},
							},
		...
		return __awaiter(this, void 0, void 0, function () {
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					...
					case 1:
						domains = _a.sent();
						match = domains.Domains.find(function (d) {
							return d.Name.toLowerCase() === domain.toLowerCase();
						});
						if (!match) return [3 /*break*/, 3];
					...
					case 3:
						console.warn(
							"Domain ".concat(domain, " not found in Postmark account"),
						);
						_a.label = 4;
					case 4:
						return [3 /*break*/, 6];
				...
				switch (_d.label) {
					...
					case 4:
						...
						if (res.ErrorCode && res.ErrorCode !== 0) {
							...
							return [
								2 /*return*/,
								{ success: false, error: res.Message || "Postmark send error" },
							];
						}
						return [
							2 /*return*/,
							{ success: true, MessageId: String(res.MessageID) },
						];
					case 5:
						err_5 = _d.sent();
						...
						return [
							2 /*return*/,
							{
								...
								error:
									(_c =
										err_5 === null || err_5 === void 0
											? void 0
											: err_5.message) !== null && _c !== void 0
										? _c
										: "Postmark send exception",
							},
						];
					case 6:
						return [2 /*return*/];
