...
var SmtpMailer = /** @class */ (function () {
	function SmtpMailer(cfg) {
		...
		this.transporter = nodemailer_1.default.createTransport({
			...
			port: cfg.port,
			secure:
				(_a = cfg.secure) !== null && _a !== void 0 ? _a : cfg.port === 465,
			auth: cfg.auth,
		...
		return __awaiter(this, void 0, void 0, function () {
			...
			return __generator(this, function (_j) {
				switch (_j.label) {
					...
					case 7:
						if (
							!((_d = this.imapClient) === null || _d === void 0
								? void 0
								: _d.authenticated)
						)
							return [3 /*break*/, 12];
					...
					case 12:
						...
						return [
							4 /*yield*/,
							(_e = this.imapClient) === null || _e === void 0
								? void 0
								: _e.close(),
						];
					case 13:
					...
					case 15:
						return [7 /*endfinally*/];
					case 16:
						return [2 /*return*/, { ok: true, message: "OK", meta: meta }];
					case 17:
						err_2 = _j.sent();
						return [
							2 /*return*/,
								...
								message:
									(_f =
										err_2 === null || err_2 === void 0
											? void 0
											: err_2.message) !== null && _f !== void 0
										? _f
										: "SMTP verify failed",
								meta: {
									code:
										err_2 === null || err_2 === void 0 ? void 0 : err_2.code,
									response:
										(err_2 === null || err_2 === void 0
											? void 0
											: err_2.response) ||
					...
					case 18:
						try {
							(_h = (_g = this.transporter).close) === null || _h === void 0
								? void 0
								: _h.call(_g);
						} catch (_k) {}
						return [7 /*endfinally*/];
				...
				switch (_c.label) {
					case 0:
						...
						return [
							4 /*yield*/,
							Promise.all(
								((_a = opts.attachments) !== null && _a !== void 0
									? _a
									: []
								).map(function (a) {
										...
										return __generator(this, function (_d) {
											switch (_d.label) {
												...
												case 1:
													return [
														2 /*return*/,
														((_c.content = _b.apply(_a, [_d.sent()])),
														(_c.contentType =
					...
					case 2:
						...
						return [
							2 /*return*/,
							{ success: true, MessageId: String(info.messageId || "") },
						];
					case 3:
						err_4 = _c.sent();
