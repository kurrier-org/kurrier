...
var MailgunMailer = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ok: false,
                                message: (_a = err_1 === null || err_1 === void 0 ? void 0 : err_1.message) !== null && _a !== void 0 ? _a : "Mailgun verify failed",
                                meta: { status: err_1 === null || err_1 === void 0 ? void 0 : err_1.status, details: err_1 === null || err_1 === void 0 ? void 0 : err_1.details },
                            }];
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.client.messages.create(domain, {
                                ...
                                text: (_c = opts === null || opts === void 0 ? void 0 : opts.body) !== null && _c !== void 0 ? _c : "This is a test email from your configured Mailgun provider.",
                            })];
                    case 1:
                        _d.sent();
        ...
        return __awaiter(this, arguments, void 0, function (domain, opts) {
            ...
            return __generator(this, function (_l) {
                switch (_l.label) {
                    ...
                    case 1:
                        _l.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.client.domains.create({
                                name: d,
                                spam_action: "tag",
                            })];
                    case 2:
                        res = _l.sent();
                        dns = [];
                        for (_i = 0, _a = (_d = res.sending_dns_records) !== null && _d !== void 0 ? _d : []; _i < _a.length; _i++) {
                            rec = _a[_i];
                            dns.push({
                        ...
                        for (_b = 0, _c = (_e = res.receiving_dns_records) !== null && _e !== void 0 ? _e : []; _b < _c.length; _b++) {
                            rec = _c[_b];
                            dns.push({
                                ...
                                note: "receiving (".concat(rec.valid ? "valid" : "pending", ")"),
                            });
                        }
                        state = (_g = (_f = res.domain) === null || _f === void 0 ? void 0 : _f.state) !== null && _g !== void 0 ? _g : "unverified";
                        status_1 = state === "active" ? "verified" : "unverified";
                        return [2 /*return*/, {
                                domain: (_j = (_h = res.domain) === null || _h === void 0 ? void 0 : _h.name) !== null && _j !== void 0 ? _j : d, // e.g. "mg.kurrier.org"
                                status: status_1,
                                dns: dns,
                                meta: {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, {
                                ...
                                status: "failed",
                                dns: [],
                                meta: { error: (_k = err_3 === null || err_3 === void 0 ? void 0 : err_3.message) !== null && _k !== void 0 ? _k : String(err_3) },
                            }];
    ...
    MailgunMailer.prototype.verifyDomain = function (domain_1) {
        return __awaiter(this, arguments, void 0, function (domain, opts) {
            var d, webHookUrl, res, dns, _i, _a, rec, _b, _c, rec, isActive, status_2, e_3;
            var _d, _e, _f, _g, _h;
            if (opts === void 0) { opts = {}; }
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        d = this.normalizeDomain(domain);
                        webHookUrl = opts === null || opts === void 0 ? void 0 : opts.webHookUrl;
                        _j.label = 1;
                    case 1:
                        _j.trys.push([1, 5, , 6]);
                    ...
                    case 3:
                        ...
                        _j.label = 4;
                    case 4: return [2 /*return*/, {
                            domain: (_g = (_f = res.domain) === null || _f === void 0 ? void 0 : _f.name) !== null && _g !== void 0 ? _g : d,
                            status: status_2,
                            dns: dns,
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, {
                                ...
                                status: "failed",
                                dns: [],
                                meta: { error: (_h = e_3 === null || e_3 === void 0 ? void 0 : e_3.message) !== null && _h !== void 0 ? _h : String(e_3) },
                            }];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        _b.sent();
                        console.log("Deleted old route ".concat(r.id, " for ").concat(domain));
                        _b.label = 5;
                    case 5:
                        _i++;
                        return [3 /*break*/, 3];
                    case 6: return [4 /*yield*/, this.client.routes.create({
                            priority: "1",
                    ...
                    case 8:
                        e_4 = _b.sent();
                        console.error("upsertInboundRoute error", (_a = e_4 === null || e_4 === void 0 ? void 0 : e_4.message) !== null && _a !== void 0 ? _a : e_4);
                        throw e_4;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        r = all_2[_i];
                        if (!((_a = r.expression) === null || _a === void 0 ? void 0 : _a.includes(domain))) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.client.routes.destroy(r.id)];
                    case 3:
                        _b.sent();
                        console.log("Deleted route ".concat(r.id, " for domain ").concat(domain));
                        _b.label = 4;
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                        ...
                        return [4 /*yield*/, Promise.all(opts.attachments.map(function (a) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_d) {
                                    switch (_d.label) {
                                        ...
                                        case 1: return [2 /*return*/, (_c.data = _b.apply(_a, [_d.sent()]),
                    ...
                    case 3:
                        ...
                        headers = {};
                        if (opts.inReplyTo)
                            headers["h:In-Reply-To"] = opts.inReplyTo;
                        if ((_b = opts.references) === null || _b === void 0 ? void 0 : _b.length)
                            headers["h:References"] = opts.references.join(" ");
                        payload = __assign({ from: opts.from, to: to, subject: opts.subject, text: opts.text || undefined, html: opts.html || undefined }, headers);
                        if (mgAttachments) {
                    ...
                    case 4:
                        res = _c.sent();
                        id = typeof (res === null || res === void 0 ? void 0 : res.id) === "string" ? res.id.replace(/^<|>$/g, "") : undefined;
