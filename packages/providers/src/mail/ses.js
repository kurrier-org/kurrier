...
var SesMailer = /** @class */ (function () {
			...
			return __generator(this, function (_c) {
				switch (_c.label) {
					case 0:
						...
						return [
							4 /*yield*/,
							this.client.send(new client_ses_1.GetSendQuotaCommand({})),
						];
					case 1:
						q = _c.sent();
					...
					case 3:
						...
						return [
							2 /*return*/,
							{
								...
								meta: {
									code:
										err_1 === null || err_1 === void 0 ? void 0 : err_1.name,
									httpStatus:
										(_b =
											err_1 === null || err_1 === void 0
												? void 0
												: err_1.$metadata) === null || _b === void 0
											? void 0
											: _b.httpStatusCode,
								},
							},
	...
	SesMailer.prototype.buildSesHeaders = function (inReplyTo, references) {
		...
		if (references && references.length > 0) {
			...
			var normalized = [];
			for (
				var _i = 0, references_1 = references;
				_i < references_1.length;
				_i++
			) {
				...
				switch (_c.label) {
					case 0:
						return [
							4 /*yield*/,
							ses.send(
								new client_ses_1.DescribeActiveReceiptRuleSetCommand({}),
							),
						];
					case 1:
						active = _c.sent();
						if (
							(_a = active.Metadata) === null || _a === void 0
								? void 0
								: _a.Name
						)
							return [
								2 /*return*/,
								{ name: active.Metadata.Name, usedExistingActive: true },
							];
						return [
							4 /*yield*/,
							ses.send(new client_ses_1.ListReceiptRuleSetsCommand({})),
						];
					case 2:
						sets = _c.sent();
						exists =
							(_b = sets.RuleSets) === null || _b === void 0
								? void 0
								: _b.some(function (r) {
					...
					case 3:
						...
						return [
							4 /*yield*/,
							ses.send(
								new client_ses_1.CreateReceiptRuleSetCommand({
									RuleSetName: desired,
								}),
							),
						];
					...
					case 6:
						return [
							4 /*yield*/,
							ses.send(
								new client_ses_1.SetActiveReceiptRuleSetCommand({
									RuleSetName: desired,
								}),
							),
						];
	...
	SesMailer.prototype.removeEmail = function (email, opts) {
		return __awaiter(this, void 0, void 0, function () {
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						ses = new client_ses_2.SES({
							region: this.cfg.region,
							credentials: this.cfg,
						});
						_a.label = 1;
					case 1:
						_a.trys.push([1, 3, , 4]);
						return [
							4 /*yield*/,
							ses.send(
								new client_ses_1.DeleteReceiptRuleCommand({
					...
					case 3:
						e_2 = _a.sent();
						code =
							(e_2 === null || e_2 === void 0 ? void 0 : e_2.name) ||
							(e_2 === null || e_2 === void 0 ? void 0 : e_2.Code);
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						...
						if (
							!(res === null || res === void 0 ? void 0 : res.bucket) ||
							!(res === null || res === void 0 ? void 0 : res.topicArn) ||
							!(res === null || res === void 0 ? void 0 : res.ruleSetName)
						) {
							throw new Error(
					...
					case 1:
						...
						ruleName = (
							(0, slugify_1.default)("".concat(normalized), {
								customReplacements: [["@", " at "]],
							}) + "-".concat((0, ulid_1.ulid)())
						).slice(0, 64);
						ruleDef = {
							Name: ruleName,
							Enabled: true,
					...
					case 2:
						...
						return [
							4 /*yield*/,
							ses.send(
								new client_ses_2.CreateReceiptRuleCommand({
					...
					case 4:
						...
						if (
							!(
								((e_3 === null || e_3 === void 0 ? void 0 : e_3.name) ||
									(e_3 === null || e_3 === void 0 ? void 0 : e_3.Code)) ===
								"RuleAlreadyExists"
							)
						)
							return [3 /*break*/, 6];
						return [
							4 /*yield*/,
							ses.send(
								new client_ses_1.UpdateReceiptRuleCommand({
									RuleSetName: activeRuleSet,
									Rule: ruleDef,
								}),
							),
					...
					case 8:
						return [
							4 /*yield*/,
							ses.send(
								new client_ses_1.SetReceiptRulePositionCommand({
									RuleSetName: activeRuleSet,
									RuleName: ruleName,
									// After: ""
								}),
	...
	SesMailer.prototype.ensureWebhookSubscription = function (
		sns,
		topicArn,
		webhookUrl,
	) {
		return __awaiter(this, void 0, void 0, function () {
			...
			return __generator(this, function (_b) {
				switch (_b.label) {
					case 0:
						if (!webhookUrl) return [2 /*return*/, { subscribed: false }];
						return [
							4 /*yield*/,
							sns.send(
								new client_sns_1.ListSubscriptionsByTopicCommand({
									TopicArn: topicArn,
								}),
							),
						];
					case 1:
						existing = _b.sent();
						same =
							(_a = existing.Subscriptions) === null || _a === void 0
								? void 0
								: _a.find(function (s) {
										var _a;
										return (
											s.Endpoint === webhookUrl &&
											((_a = s.Protocol) === null || _a === void 0
												? void 0
												: _a.startsWith("http"))
										);
									});
						...
						return [
							4 /*yield*/,
							sns.send(
								new client_sns_1.SubscribeCommand({
									TopicArn: topicArn,
			...
			return __generator(this, function (_h) {
				switch (_h.label) {
					case 0:
						...
						return [
							4 /*yield*/,
							sts.send(new client_sts_1.GetCallerIdentityCommand({})),
						];
					case 1:
						(_b = _h.sent().Account), (accountId = _b === void 0 ? "" : _b);
						(_c = this.baseNames(id)),
							(bucket = _c.bucket),
							(topicName = _c.topicName),
							(ruleSetName = _c.ruleSetName),
							(defaultRuleName = _c.defaultRuleName),
							(s3NotifId = _c.s3NotifId);
						bucketExists = false;
						_h.label = 2;
					case 2:
						_h.trys.push([2, 4, , 9]);
						return [
							4 /*yield*/,
							s3.send(new client_s3_1.HeadBucketCommand({ Bucket: bucket })),
						];
					case 3:
						_h.sent();
						bucketExists = true;
					...
					case 5:
						...
						return [
							4 /*yield*/,
							s3.send(new client_s3_1.CreateBucketCommand(input)),
						];
					case 6:
						_h.sent();
						bucketExists = true;
					...
					case 7:
						e_4 = _h.sent();
						code =
							(e_4 === null || e_4 === void 0 ? void 0 : e_4.name) ||
							(e_4 === null || e_4 === void 0 ? void 0 : e_4.Code);
						if (code !== "BucketAlreadyOwnedByYou") throw e_4;
						bucketExists = true;
						return [3 /*break*/, 8];
					case 8:
						return [3 /*break*/, 9];
					case 9:
						...
						return [
							4 /*yield*/,
							s3.send(
								new client_s3_1.PutBucketPolicyCommand({
									Bucket: bucket,
					...
					case 10:
						...
						return [
							4 /*yield*/,
							s3.send(
								new client_s3_1.PutPublicAccessBlockCommand({
									Bucket: bucket,
					...
					case 11:
						...
						return [
							4 /*yield*/,
							sns.send(
								new client_sns_1.CreateTopicCommand({ Name: topicName }),
							),
						];
					case 12:
					...
					case 13:
						...
						return [
							4 /*yield*/,
							sns.send(
								new client_sns_1.GetTopicAttributesCommand({
									TopicArn: topicArn,
								}),
							),
						];
					...
					case 16:
							...
							Statement: [
								...
								// },
								{
									...
									Condition: {
										StringEquals: { "aws:SourceAccount": accountId },
										ArnLike: {
											"aws:SourceArn": "arn:aws:s3:::".concat(bucket),
										},
									},
								},
							],
						...
						return [
							4 /*yield*/,
							sns.send(
								new client_sns_1.SetTopicAttributesCommand({
									TopicArn: topicArn,
					...
					case 18:
						...
						return [
							4 /*yield*/,
							s3.send(
								new client_s3_1.PutBucketNotificationConfigurationCommand({
									Bucket: bucket,
					...
					case 20:
						(_f = _h.sent()),
							(ruleSetNameInUse = _f.name),
							(usedExistingActive = _f.usedExistingActive);
						ruleCreated = false;
						if (!!usedExistingActive) return [3 /*break*/, 23];
						return [
							4 /*yield*/,
							ses.send(
								new client_ses_2.DescribeReceiptRuleSetCommand({
					...
					case 21:
						current = _h.sent();
						hasRule =
							(_g = current.Rules) === null || _g === void 0
								? void 0
								: _g.some(function (r) {
										return r.Name === defaultRuleName;
									});
				...
				switch (_f.label) {
					...
					case 1:
						...
						return [
							4 /*yield*/,
							this.v2.send(
								new client_sesv2_1.CreateEmailIdentityCommand({
					...
					case 3:
						...
						if (
							(err_2 === null || err_2 === void 0 ? void 0 : err_2.name) !==
								"ConflictException" &&
							(err_2 === null || err_2 === void 0 ? void 0 : err_2.name) !==
					...
					case 4:
						return [
							4 /*yield*/,
							this.v2.send(
								new client_sesv2_1.GetEmailIdentityCommand({
									EmailIdentity: domain,
								}),
							),
						];
					case 5:
						...
						tokens =
							(_d =
								(_c = info.DkimAttributes) === null || _c === void 0
									? void 0
									: _c.Tokens) !== null && _d !== void 0
								? _d
								: [];
						dkimRecords = tokens.map(function (t) {
							return {
								type: "CNAME",
					...
					case 7:
						...
						return [
							2 /*return*/,
							{
								...
								dns: __spreadArray(
									__spreadArray(
										__spreadArray([], dkimRecords, true),
										extraDns,
										true,
									),
									incomingDns,
								...
								meta: __assign(
									{
										...
										signingAttributesOrigin:
											(_e = info.DkimAttributes) === null || _e === void 0
												? void 0
												: _e.SigningAttributesOrigin,
									},
				...
				switch (_d.label) {
					case 0:
						...
						if (!mf.endsWith(".".concat(domain))) {
							throw new Error(
								"MAIL FROM must be a subdomain of ".concat(domain),
							);
						}
						return [
							4 /*yield*/,
							this.v2.send(
								new client_sesv2_1.PutEmailIdentityMailFromAttributesCommand({
									EmailIdentity: domain,
									MailFromDomain: mf,
					...
					case 2:
						info = _d.sent();
						feedbackHost = "feedback-smtp.".concat(
							this.cfg.region,
							".amazonses.com",
						);
						dns = [
						...
						return [
							2 /*return*/,
							{
								...
								meta: {
									mailFromDomain:
										(_a = info.MailFromAttributes) === null || _a === void 0
											? void 0
											: _a.MailFromDomain,
									mailFromDomainStatus:
										(_b = info.MailFromAttributes) === null || _b === void 0
											? void 0
											: _b.MailFromDomainStatus,
									behaviorOnMxFailure:
										(_c = info.MailFromAttributes) === null || _c === void 0
											? void 0
											: _c.BehaviorOnMxFailure,
								},
							},
						];
				}
				...
				switch (_c.label) {
					...
					case 1:
						...
						return [
							4 /*yield*/,
							this.client.send(
								new client_sesv2_1.DeleteEmailIdentityCommand({
									EmailIdentity: d,
								}),
							),
						];
					...
					case 3:
						e_5 = _c.sent();
						notFound =
							(e_5 === null || e_5 === void 0 ? void 0 : e_5.name) ===
								"NotFoundException" ||
							((_b =
								e_5 === null || e_5 === void 0 ? void 0 : e_5.$metadata) ===
								null || _b === void 0
								? void 0
								: _b.httpStatusCode) === 404;
						if (!notFound) throw e_5;
						return [3 /*break*/, 4];
					case 4:
						_c.trys.push([4, 6, , 7]);
						return [
			...
			return __generator(this, function (_j) {
				switch (_j.label) {
					...
					case 2:
						...
						tokens =
							(_b =
								(_a = info.DkimAttributes) === null || _a === void 0
									? void 0
									: _a.Tokens) !== null && _b !== void 0
								? _b
								: [];
						dkimRecords = tokens.map(function (t) {
							return {
						...
						mf =
							(_d =
								(_c = info.MailFromAttributes) === null || _c === void 0
									? void 0
									: _c.MailFromDomain) === null || _d === void 0
								? void 0
								: _d.trim().replace(/\.$/, "");
						mailFromDns = mf
							? [
								...
								meta: {
									...
									mailFrom: mf
										? {
												mailFromDomain: mf,
												mailFromDomainStatus:
													(_f = info.MailFromAttributes) === null ||
													_f === void 0
														? void 0
														: _f.MailFromDomainStatus,
												behaviorOnMxFailure:
													(_g = info.MailFromAttributes) === null ||
													_g === void 0
														? void 0
														: _g.BehaviorOnMxFailure,
											}
										: undefined,
					...
					case 3:
						e_6 = _j.sent();
						notFound =
							(e_6 === null || e_6 === void 0 ? void 0 : e_6.name) ===
								"NotFoundException" ||
							((_h =
								e_6 === null || e_6 === void 0 ? void 0 : e_6.$metadata) ===
								null || _h === void 0
								? void 0
								: _h.httpStatusCode) === 404;
						return [
							2 /*return*/,
							{
								domain: d,
								...
								meta: {
									error: notFound
										...
										: e_6 === null || e_6 === void 0
											...
											: e_6.name,
									message:
										e_6 === null || e_6 === void 0 ? void 0 : e_6.message,
								},
							},
						];
					case 4:
			...
			return __generator(this, function (_c) {
				switch (_c.label) {
					case 0:
						subject =
							(_a =
								opts === null || opts === void 0 ? void 0 : opts.subject) !==
								null && _a !== void 0
								? _a
								: "Test email";
						body =
							(_b = opts === null || opts === void 0 ? void 0 : opts.body) !==
								null && _b !== void 0
								? _b
				...
				return __awaiter(this, void 0, void 0, function () {
					...
					return __generator(this, function (_a) {
						return [
							2 /*return*/,
							Promise.all(
								inputs.map(function (att) {
									return __awaiter(_this, void 0, void 0, function () {
										var ab, bytes, out;
										return __generator(this, function (_a) {
											switch (_a.label) {
												case 0:
													return [4 /*yield*/, att.content.arrayBuffer()];
												case 1:
													ab = _a.sent();
				...
				switch (_b.label) {
					case 0:
						return [
							4 /*yield*/,
							toSesV2Attachments(
								(_a = opts.attachments) !== null && _a !== void 0 ? _a : [],
							),
						];
					case 1:
					...
					case 2:
						...
						return [
							4 /*yield*/,
							this.v2.send(
								new client_sesv2_1.SendEmailCommand({
					...
					case 3:
						...
						return [
							2 /*return*/,
							{
								MessageId: "<"
									.concat(MessageId, "@")
									.concat(this.cfg.region, ".amazonses.com>"),
								success: true,
							},
						];
					case 4:
